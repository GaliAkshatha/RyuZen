/** Matches the real backend IOrganizationSettings exactly - confirmed directly, all 18 groups. */
...
/** Matches UpdateOrganizationSettingsSchema exactly - every group and every field within it is optional, a real partial-update contract. */
export type UpdateOrganizationSettingsRequest = Partial<{
  [K in keyof Omit<OrganizationSettings, "id" | "organizationId" | "createdAt" | "updatedAt">]: Partial<OrganizationSettings[K]>;
}>;
