...
/**
 * Real Placement Admin shell - Companies (create/list) and Drives
 * (create/publish/close, plus real application review with status
 * updates) are what's built. Recruiter account management is a
 * confirmed backend gap from earlier work on this backend (POST
 * /recruiters exists but no GET /recruiters list endpoint) - not
 * fabricated here.
 */
